...
export default function InterviewRoom() {
  ...
  const officerConfig = {
    // We changed the first message to end with a direct question so you know when to answer
    firstMessage: "Hello. I am the consular officer. Please state your full name and the specific engineering program you are applying for in China.",
    model: {
      provider: "openai",
      model: "gpt-4o-mini",
      messages: [
        {
          role: "system",
          content: "You are a strict, time-conscious interviewing officer evaluating a candidate for the Chinese Government Scholarship. You just asked for their name and program. When they reply, cross-examine their answer. Ask about their mechatronics background or their projects with microcontrollers. If they talk for more than 30 seconds, firmly interrupt them. Keep your responses short and professional."
        }
      ]
    }
  };
